...
import type { AppStorage, RequestMethod, Route, RouteMap } from "@remix-run/fetch-router";
 ...
 */
export interface MutationClientRouteContext<
    P extends Record<string, string> = Record<string, string>
> extends BaseClientRouteContext<P> {
    method: Exclude<FormMethod, "GET">;
    formData: FormData;
}
 ...
 */
export type ClientRouteHandler<M extends string = string, P extends string = string> = M extends
    | "GET"
    | "ANY"
